System.config({
  ...
  bundles: {
    "app-build": [
      ...
      "blur-image",
      "child-router",
      "child-router.html!github:systemjs/plugin-text@0.0.4",
      "contact",
      "contact.html!github:systemjs/plugin-text@0.0.4",
      "github",
      "github.html!github:systemjs/plugin-text@0.0.4",
      "ig",
      "ig.html!github:systemjs/plugin-text@0.0.4",
      "main",
      "nav-bar.html!github:systemjs/plugin-text@0.0.4",
      "pinboard",
      "pinboard.html!github:systemjs/plugin-text@0.0.4",
      "reasons",
      "reasons.html!github:systemjs/plugin-text@0.0.4",
      "router-config",
      "styles.css!github:systemjs/plugin-text@0.0.4",
      "svg",
      "svg.html!github:systemjs/plugin-text@0.0.4",
      "users",
      "users.html!github:systemjs/plugin-text@0.0.4",
      "welcome",
      "welcome.html!github:systemjs/plugin-text@0.0.4",
      "who",
      "who.html!github:systemjs/plugin-text@0.0.4",
      "words",
      "words.html!github:systemjs/plugin-text@0.0.4"
    ],
    "aurelia": [
  ...
  map: {
    ...
    "paulvanbladel/aurelia-auth": "github:paulvanbladel/aurelia-auth@0.11.4",
